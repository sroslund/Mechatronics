...
#define EVENT_CHECK_LIST  TemplateCheckBattery, BumperCheckEvent, BeaconCheckEvent,TrackCheckEvent, SideCheckEvent, TimeCheck, TapeCheckEvent
...
#define TIMER3_RESP_FUNC PostDrivingService
...
#define DEFAULT 0 /*make sure this is enabled above and posting to the correct state machine*/
#define REALIGN 1
#define DONOT 2
#define DRIVING_SERVICE_TIMER 3
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "DrivingService.h"
// the name of the Init function
#define SERV_1_INIT InitDrivingService
// the name of the run function
#define SERV_1_RUN RunDrivingService
// How big should this services Queue be?
#define SERV_1_QUEUE_SIZE 254
#endif
