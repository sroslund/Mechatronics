...
#define EVENT_CHECK_HEADER "Test_HarnessEventChecker.h"
...
#define EVENT_CHECK_LIST  TemplateCheckBattery, BeaconCheckEvent, BumperCheckEvent, TrackCheckEvent, TapeCheckEvent
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "Test_HarnessService.h"
// the name of the Init function
#define SERV_1_INIT InitTestService
// the name of the run function
#define SERV_1_RUN RunTestService
